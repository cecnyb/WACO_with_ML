...
class SuperScheduleDataset(torch.utils.data.Dataset):
    def __init__(self, name):
      ...
      with open("/home/s0/ml4sys02/project/Workload-Aware-Co-Optimization/WACO/SpMM/TrainingData/CollectedData/"+name+".txt") as f:
        lines = f.read().splitlines()
        lines = [line.split() for line in lines]
        lines = [line for line in lines if "Testing" in line]
