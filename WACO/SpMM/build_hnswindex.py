...
if __name__ == "__main__":
  ...
  schedules = TrainingScheduleDataset("/home/s0/ml4sys02/project/Workload-Aware-Co-Optimization/WACO/SDDMM/TrainingData/test_filtered_small.txt")
  schedule_loader = torch.utils.data.DataLoader(schedules, batch_size=64, shuffle=False, num_workers=0)
